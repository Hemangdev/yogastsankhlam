                                ...
                                <div className="max-w-lg w-full lg:max-w-full lg:flex my-5">
                                    ...
                                    <div className="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
                                        <div className="mb-8">
                                            ...
                                            <div className="text-gray-900 font-bold text-xl mb-2">Sophia Mesabhi on Profitable and Sustainable Growth</div>
                                            <p className="text-gray-700 text-base">Sophia Mesabhi is a Senior Partner at Untitled Ventures. Frankie Sullivan sat down with her to chat about sustainable and profitable growth...</p>
                                        </div>
                                        <div className="flex items-center">
                                            <img className="w-10 h-10 rounded-full mr-4" src="https://placehold.co/10x10" alt="Avatar of Jonathan Reinink" />
                                            <div className="text-sm">
                                                <p className="text-gray-900 leading-none">Dipanita Biswas</p>
                                                <p className="text-gray-600">01 November 2024</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
