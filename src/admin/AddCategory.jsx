...
const AddCategory = () => {
    ...
    return (
        <>
            <h1 className='text-3xl sm:text-4xl md:text-5xl'>Add Category</h1>
            <div className="flex justify-end mb-4 ">
                ...
                <Link to={'/admin/dashboard/all-blog-category'}>
                    <button className='px-4 py-2 bg-green-700 text-white font-bold rounded-md mx-2 my-2'>Categories List</button>
                </Link>
            </div>
